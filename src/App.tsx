...
function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section id="home" className="relative min-h-[80vh] sm:min-h-screen bg-air-blue text-white flex items-center">
        <div className="absolute inset-0">
            <img
              src={ASSETS.beachBackground}
              alt="Background"
              className="w-full h-full object-cover object-[center_top] opacity-20"
            />
        </div>
        <AnimatedSection className="relative w-full">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-12 sm:py-24">
            <div className="mb-6 sm:mb-12">
              <img
                src={ASSETS.hoffmangruppeLogo}
                alt="Hoffmangruppe Promotions"
                className="h-16 sm:h-24 w-auto rounded-lg"
              />
            </div>
                ...
                <div className="bg-gradient-to-br from-air-blue to-air-blue-700 p-8 sm:p-12 rounded-xl">
                  <div className="mb-8 sm:mb-12">
                    <img
                      src={ASSETS.kbLogo}
                      alt="Kaeser & Blair"
                      className="h-20 sm:h-24 w-auto mb-6 sm:mb-8 mx-auto"
                    />
